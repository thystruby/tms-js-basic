...
// const surname = null;
// let age;
// console.log(`${typeof(num)}, ${typeof(str)}, ${typeof(isTrue)}, ${typeof(surname)}, ${typeof(age)}`);
...
// const greet = "Привет";
// let name = prompt("Как вас зовут?", "Имя пользователя");
// alert(`${greet} ${name}`);
...
// let result = confirm("Получить доступ?");
// alert(result);