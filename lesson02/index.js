 ...
 * Например: nikitaP/lesson02. Выполнение задания производится в свое ветке и в этом файле.
 ...
 * Если confirm будет true, то запросите у пользователя его возраст и идите к следующему пункту, иначе ничего не делайте. 
 ...
 * Можете попробовать использовать switch. Если не получится, то используйте if. Подсказка: switch(true)
*/
