...
console.log(`Длина гипотенузы: ${k}`)
*/
...
/** 
let num1 = prompt('Введите первое число:', 'Число 1');
let num2 = prompt('Введите второе число:', 'Число 2');
...
if (access===true) {
  const name = prompt('Введите возраст:', 'Возраст');
  if (name >= 18 ? alert('Доступ разрешен') : alert('Доступ запрещен'));
}
*/
...
if ((Number.isNaN(num1) === false) && (Number.isNaN(num2) === false)) {
  if (num1 > num2 ? alert(`Остаток от деления: ${num1%num2}`) : alert(`Остаток от деления: ${num2%num1}`));
} else {
  alert('Произошла ошибка'); 
} 
