...
// let bool = true;
// let z = null;
// console.log(Boolean(bool), String(str), Number(num));
...
// console.log(a1, z, a2, z, a3, z, a4, z, a5);
...
*/
// let a = + prompt('Inter value a');

// if (isNaN(a)) {
//     alert(a + 'Произовла ошибка', 'введите число');
// }
// else {
//     alert(a + '-это число');
...
// let b = + prompt('Inter value b');
// if (isNaN(b)) {
//     alertt(b + 'Произовла ошибка', 'введите число');
// }
// else {
//     alert(b + '-это число');
...
// let age;
// age = 'age';
// if (confirm("Хотите получить доступ?")) {
//     prompt(age);
// }
// let num = Number(age);

// alert = num >= 18 ? alert('Доступ разрешен') : alert('Дoступ запрещен');

//Не понимаю ,почему не отрабатывает доступ разрешен.:(
