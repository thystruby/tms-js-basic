...
// let c = true;
// let d = null;
// console.log(Boolean(a), String(b), Number(c), Number(d))
...
// if(
//   (typeof +number1 == 'number' && !isNaN(+number1)) &&
//   (typeof +number2 == 'number' && !isNaN(+number2))
//   ) {
//   number1 === number2 ? alert(`Числа равны: ${number1} ${number2}`) : alert('Произошла ошибка')
// }
// else{
...
*/
// const access = confirm('Хотите поучить доступ?');
// let age = null;
// access ? age = prompt('Сколько Вам лет?') : null;
...
// typeof +a == 'number' && !isNaN(+a) && typeof +b == 'number' && !isNaN(+b) ? alert(a%b) : null;